"""
analyze_real_data_08112026.py
===============================

DLVO analysis of the second real DLS dataset (08/11/2026): expanded pH
...
CSV_PATH = os.path.join(HERE, "data_DLVO", "DLS_data_zein_caseinate_08112026.csv")
OUTDIR = os.path.join(HERE, "outputs", "real_data_08112026")
...
def plot_energy_profiles(agg, hamaker_J, out_path):
    ...
    ax.set_title("DLVO energy profiles -- real DLS, 08/11/2026 (single replicate, preliminary)", fontsize=10)
...
def plot_stability_map(sweep_df, agg, out_path):
    ...
    ax.set_title("Predicted colloidal stability map -- real DLS, 08/11/2026 (single replicate, preliminary)", fontsize=10)
    for cond in pipeline.TARGET_CONDITIONS:
